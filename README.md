...
Link : https://raw.githubusercontent.com/AICP/vendor_aicp/v15.0/docs/xda_template/xda_thread-template.txt
...
5th use the following command to push your commit to gerrit
    ...
    . build/envsetup.sh
    repo start v15.0 path/to/project
    cd path/to/project
    repo upload .
...
Example:
    ...
    git push ssh://USERNAME@gerrit.aicp-rom.com:29418/AICP/platform_manifest HEAD:refs/for/v15.0
...
-------------------------------
https://github.com/AICP/vendor_aicp/blob/v15.0/docs/aicpInfo.md
